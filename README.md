...
```
debraj@Nexlas-MacBook-Pro repository % cd ~/.m2/repository/org/apache/kafka/connect-runtime/7.3.15-hack-ccs
debraj@Nexlas-MacBook-Pro 7.3.15-hack-ccs % ls
connect-runtime-7.3.15-hack-ccs-javadoc.jar	connect-runtime-7.3.15-hack-ccs-test-sources.jar	connect-runtime-7.3.15-hack-ccs.jar		connect-runtime-7.3.15-hack-ccs.pom
connect-runtime-7.3.15-hack-ccs-sources.jar	connect-runtime-7.3.15-hack-ccs-test.jar		connect-runtime-7.3.15-hack-ccs.module
```
...
Publish `connect-runtime-7.3.15-hack-ccs.jar` and `connect-runtime-7.3.15-hack-ccs.pom` to artifactory using the steps outlined [here](https://nexla1.atlassian.net/browse/NEX-18101).
